...
const DevicePage = () => {
  ...
  const handleRemove = (deviceId) => {
    ...
    if (option) {
      fetch(`/api/devices/${deviceId}`, { method: "DELETE" }).then(
        (response) => {
          if (response.ok) {
            console.log(response);
          }
        ...
        {devices.map((device, index) => (
          <Card key={index} className={classes.root}>
            ...
            >
              ...
              <MenuItem
                onClick={() => handleOpenFullDialog(variable.notificacion)}
              >
                ...
                >
                  ...
                  >
                    ...
                    <ListItemText>
                      ...
                      {positions && positions[device.id]
                        ? positions[device.id].deviceTime
                        : "Undefined"}
                    </ListItemText>
                  </ListItem>
                  <ListItem
                  ...
                  >
                    ...
                    <ListItemText style={{ fontSize: "12px" }}>
                      ...
                      {positions && positions[device.id]
                        ? Boolean(positions[device.id].valid).toString()
                        : "Undefined"}
                    </ListItemText>
                  </ListItem>
                  <ListItem
                  ...
                  >
                    ...
                    <ListItemText>
                      ...
                      {positions && positions[device.id]
                        ? Boolean(positions[device.id].ignition).toString()
                        : "Undefined"}
                    </ListItemText>
                  </ListItem>
                  <ListItem
