      ...
      <Grid container component="main" className={classes.root}>
        ...
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
          ...
          <div className={classes.paper}
               style={{display: signUpView ? 'flex' : 'none',
                 margin: '47px 32px'}}>
            ...
            <form className={classes.form} id="formreg">
              <ListItem style={{padding: 0}}>
                ...
                <i title="No deberá contener más de 30 caracteres" onClick={() => setFailed(!failed)}
              ...
              <TextField
                ...
                onChange={handleEmailChange}/>
                  ...
                  <i title="Deberá ingresar un email válido para confirmar"
                     className={`far fa-question-circle ${classes.faIcons}`}/>
              ...
              <TextField
                ...
                <i title="Ver/Ocultar Password" style={{right: '7%'}}
                   onClick={()=> setPassVisible(!passVisible)}
                  className={`${passVisible ? 'far fa-eye-slash' : 'far fa-eye'} ${classes.faIcons}`}/>
              ...
              <Button  className="btn-submit-register"
                       // type="submit"
                       fullWidth
                       variant="contained"
                       color="success"
          ...
          <div>
            ...
            >
              <DialogTitle id="alert-dialog-title">{t('serverRegistration')}</DialogTitle>
              <DialogContent>
